...
public class SeatDTO {
    ...
    public SeatDTO(Seat seat){
        ...
        this.reserved = seat.getReserved(); //why does this method not get generated with the rest of them?
    }
    ...
    public static Seat seatFromSeatDTO(SeatDTO seat){
        return new Seat(seat.getRow(),seat.getColumn(),seat.getReserved());
    }
}
