...
//
//        /*Movie movie1 = new Movie("fake id","Dune", "13", "Timothee Chalamet, Rebecca Fergyson, Zendja", "2021", "Sci-fi", "A guy is born into a royal family and tries to survive the first part", "155");
//        Movie movie2 = new Movie("fake id","No Time To Die", "13", "Daniel Craig, Ana de Armas", "2021", "Action", "James Bond has left the active service and enjoys his retirement", "163");
//        Movie movie3 = new Movie("fake id","Shang-Chi", "13", "Simu Liu, Awkwafina, Tony Chiu-Wai Leung", "2021", "Fantasy", "Shang-Chi, the master of weaponry-based Kung Fu, is forced to confront his past", "132");
